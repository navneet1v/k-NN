...
/**
 * Writes KNN Index for a field in a segment. This is intended to be used for native engines. This class uses the local CPU path for building segments.
 * See {@link RemoteNativeIndexWriter} for remote vector index build path.
 */
@AllArgsConstructor
@Log4j2
