...
public class PrefetchableFlatVectorScorer implements FlatVectorsScorer {
     ...
     */
    public PrefetchableFlatVectorScorer(final FlatVectorsScorer flatVectorsScorer) {
    ...
    public RandomVectorScorer getRandomVectorScorer(
        ...
        return new PrefetchableRandomVectorScorer(
            (RandomVectorScorer.AbstractRandomVectorScorer) flatVectorsScorer.getRandomVectorScorer(
                similarityFunction,
                vectorValues,
                target
            )
    ...
    static class PrefetchableRandomVectorScorerSupplier implements RandomVectorScorerSupplier {
         ...
         */
        public PrefetchableRandomVectorScorerSupplier(RandomVectorScorerSupplier randomVectorScorerSupplier, KnnVectorValues vectorValues) {
        ...
        public UpdateableRandomVectorScorer scorer() throws IOException {
            return new PrefetchableUpdatableRandomVectorScorer(this.randomVectorScorerSupplier.scorer(), vectorValues);
        }

        @Override
        public RandomVectorScorerSupplier copy() throws IOException {
            return new PrefetchableRandomVectorScorerSupplier(randomVectorScorerSupplier.copy(), vectorValues.copy());
        }
    }
    ...
    static class PrefetchableRandomVectorScorer extends RandomVectorScorer.AbstractRandomVectorScorer {
        ...
        public float bulkScore(int[] nodes, float[] scores, int numNodes) throws IOException {
            log.info("Might do prefetch in PrefetchableRandomVectorScorer");
     ...
     */
    @Log4j2
    static class PrefetchableUpdatableRandomVectorScorer extends UpdateableRandomVectorScorer.AbstractUpdateableRandomVectorScorer {
         ...
         * @param vectorValues the vector values for prefetching
         */
        PrefetchableUpdatableRandomVectorScorer(final UpdateableRandomVectorScorer delegate, final KnnVectorValues vectorValues) {
            super(vectorValues);
            this.delegate = delegate;
        }
        ...
        @Override
        public float bulkScore(int[] nodes, float[] scores, int numNodes) throws IOException {
            log.info("Might do prefetch in PrefetchableUpdatableRandomVectorScorer");
            PrefetchableVectorValuesHelper.mayBeDoPrefetch(values(), nodes, numNodes);
