...
public class KNNWeight extends Weight {
    ...
    public Scorer scorer(LeafReaderContext context) throws IOException {
        ...
        // We don't need to go to JNI layer as no documents are found which satisfy the filters
        // We should give this condition a deeper look that where it should be placed.
