 ...
 */
@Log4j2
public class SimpleQueryHandler2 extends BaseRestHandler {

    public static final String NAME = "simple_query_api2";
    ...
    public List<Route> routes() {
        return ImmutableList.of(new Route(RestRequest.Method.POST, "/vector_search/{index}/_query2"));
    }
}
